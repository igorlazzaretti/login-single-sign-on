...
<div align="center">
  <img src="./src/assets/react.svg" width="300px" height="300px">
</div>

# 🗡️ Login Single Sing-On Temático Tibia



- HTML, CSS e Tailwind para a estrutura do site.
- Javascript com funções: 
- Confira e utilize o projeto neste <a href="https://igorlazzaretti.github.io/pomodoro/"> link</a>.

## 🚀 Tecnologias Utilizadas

**Front-End:** HTML, CSS, Tailwind, JavaScript e React;

## Principais recursos:

- 🎨 **Design:** Inspirado no jogo Tibia 1997;
- 🧩 **Organização:** Estrutura limpa e simples;
- 📱 **Layout Responsivo:** Compatível com dispositivos móveis;
- 🫆 **Logins Único**: Funciona como um app nativo para o celular ou para o desktop;
